  ...
  return (
    <div className="flex flex-col w-full bg-[var(--bg-warm)]">
      ...
      <div className="flex w-full h-[800px]">
        {/* Sidebar */}
        <div className="flex flex-col w-[400px] h-full bg-[var(--bg-white)] border-r border-[var(--border-subtle)] shrink-0 overflow-auto">
          {/* Sidebar Header */}
      ...
      {/* Stats Bar */}
      <div className="flex items-center justify-between px-[80px] py-[24px] bg-[var(--bg-white)] border-t border-[var(--border-subtle)] w-full">
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-label font-bold text-[10px] tracking-[2px] text-[var(--text-muted)]">TODAY&apos;S DISTANCE</span>
          <span className="font-heading font-semibold text-[28px] text-[var(--text-primary)]">18.4 mi</span>
        </div>
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-label font-bold text-[10px] tracking-[2px] text-[var(--text-muted)]">ELEVATION GAIN</span>
          <span className="font-heading font-semibold text-[28px] text-[var(--text-primary)]">+2,340 ft</span>
        </div>
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-label font-bold text-[10px] tracking-[2px] text-[var(--text-muted)]">TOTAL MILES</span>
          <span className="font-heading font-semibold text-[28px] text-[var(--forest-green)]">42.7 / 2,650</span>
        </div>
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-label font-bold text-[10px] tracking-[2px] text-[var(--text-muted)]">CURRENT ELEVATION</span>
          <span className="font-heading font-semibold text-[28px] text-[var(--text-primary)]">3,845 ft</span>
        </div>
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-label font-bold text-[10px] tracking-[2px] text-[var(--text-muted)]">DAY</span>
          <span className="font-heading font-semibold text-[28px] text-[var(--burnt-orange)]">3 of ~180</span>
        </div>
      </div>
