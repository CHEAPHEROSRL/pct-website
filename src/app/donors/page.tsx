...
export default function DonorsPage() {
  return (
    <div className="flex flex-col w-full bg-[var(--bg-warm)]">
      ...
      {/* Hero */}
      <section className="flex flex-col items-center gap-[32px] px-[120px] py-[64px] bg-[var(--bg-white)] w-full">
        ...
        {/* Progress Card */}
        <div className="flex flex-col gap-[16px] bg-[var(--bg-card)] border border-[var(--border-subtle)] p-[32px] w-[640px]">
      ...
      {/* Filter Bar */}
      <div className="flex items-center justify-between px-[120px] py-[16px] bg-[var(--bg-warm)] w-full">
        <div className="flex items-center gap-[10px] bg-[var(--bg-white)] border border-[var(--border-subtle)] px-[16px] py-[10px]">
        ...
        <span className="font-label font-semibold text-[11px] tracking-[2px] text-[var(--text-muted)]">47 DONORS</span>
      </div>

      {/* Donor List */}
      <section className="flex flex-col px-[120px] pb-[80px] bg-[var(--bg-warm)] w-full">
        {/* Table Header */}
        <div className="flex bg-[var(--bg-dark)] px-[20px] py-[12px] w-full">
        ...
        {/* Rows */}
        {donors.map((d, i) => (
          <div key={i} className={`flex items-center px-[20px] py-[16px] border-b border-[var(--border-subtle)] w-full ${i % 2 === 0 ? "bg-[var(--bg-white)]" : "bg-[var(--bg-card)]"}`}>
