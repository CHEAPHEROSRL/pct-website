    ...
    <div className="flex flex-col w-full bg-[var(--bg-warm)]">
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-3 md:gap-0 px-6 md:px-12 lg:px-[120px] py-[16px] bg-[var(--bg-white)] border-t border-b border-[var(--border-subtle)] w-full">
        <div className="flex items-center gap-[8px] flex-wrap">
          ...
          <div className="border border-[var(--border-subtle)] px-[20px] py-[8px]">
            <span className="font-label font-bold text-[11px] tracking-[2px] text-[var(--text-secondary)]">BLOG</span>
          </div>
          <div className="border border-[var(--border-subtle)] px-[20px] py-[8px]">
            <span className="font-label font-bold text-[11px] tracking-[2px] text-[var(--text-secondary)]">VLOG</span>
          </div>
          <div className="border border-[var(--border-subtle)] px-[20px] py-[8px]">
            <span className="font-label font-bold text-[11px] tracking-[2px] text-[var(--text-secondary)]">PHOTOS</span>
          </div>
        </div>
        <div className="flex items-center gap-[10px] border border-[var(--border-subtle)] px-[16px] py-[10px]">
          ...
          <span className="font-heading text-[14px] text-[var(--text-muted)]">Search journal entries...</span>
        </div>
      </div>
      ...
      <section className="flex flex-col lg:flex-row gap-[24px] lg:gap-[40px] px-6 md:px-12 lg:px-[120px] py-[32px] md:py-[48px] bg-[var(--bg-white)] w-full">
        ...
        <div className="flex flex-col justify-center gap-[20px] flex-1">
          ...
          <p className="font-heading text-[16px] leading-[1.7] text-[var(--text-secondary)]">
            Standing at the southern monument, looking north toward Canada. 2,650 miles of trail ahead. The sun is barely up and the desert air is still cool. This is the moment I&apos;ve been preparing for — the moment everything changes. For mom. For dad. For everyone still fighting.
          </p>
      ...
      <section className="flex flex-col gap-[24px] px-6 md:px-12 lg:px-[120px] pt-[32px] md:pt-[48px] pb-[48px] md:pb-[80px] bg-[var(--bg-warm)] w-full">
        ...
        <div className="flex items-center justify-center gap-[8px] w-full">
          ...
          <div className="flex items-center justify-center w-[40px] h-[40px] border border-[var(--border-subtle)]">
          ...
          <span className="font-label font-semibold text-[13px] text-[var(--text-muted)]">...</span>
          <div className="flex items-center justify-center w-[40px] h-[40px] border border-[var(--border-subtle)]">
            <span className="font-label font-semibold text-[13px] text-[var(--text-secondary)]">10</span>
          </div>
          <div className="flex items-center gap-[6px] border border-[var(--border-subtle)] px-[16px] py-[10px]">
...
function BlogCard({ img, day, date, title, excerpt, tag }: {
  img: string; day: string; date: string; title: string; excerpt: string; tag: string;
}) {
