  ...
  return (
    <div className="flex flex-col w-full bg-[var(--bg-warm)]">
      ...
      <section className="relative w-full h-[720px] overflow-hidden">
        ...
        />
        <div className="relative flex flex-col justify-end gap-[24px] h-full px-[120px] pb-[80px]">
          ...
          <h1 className="font-heading font-semibold text-[56px] leading-[1.1] tracking-[-1px] text-[var(--text-white)] w-[800px]">
            One man. One trail.{"\n"}One cause worth walking for.
          </h1>
          <p className="font-heading text-[20px] leading-[1.6] text-[#FFFFFFCC] w-[700px]">
          ...
          <div className="flex items-center gap-[16px]">
            <Link
              href="/donate"
              className="flex items-center gap-[10px] bg-[var(--burnt-orange)] px-[40px] py-[18px] hover:opacity-90 transition-opacity"
            >
            ...
            <Link
              href="/trail-map"
              className="flex items-center gap-[10px] border border-[#FFFFFF66] px-[40px] py-[18px] hover:bg-white/10 transition-colors"
            >
              <span className="font-label font-bold text-[14px] tracking-[2px] text-[var(--text-white)]">
                FOLLOW THE JOURNEY
              </span>
      ...
      {/* Stats Bar */}
      <section className="flex items-center justify-around px-[80px] py-[28px] bg-[var(--bg-dark)] w-full">
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-heading font-semibold text-[36px] tracking-[-1px] text-[var(--burnt-orange)]">2,650</span>
          <span className="font-label font-bold text-[10px] tracking-[3px] text-[var(--text-muted)]">MILES TO WALK</span>
        </div>
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-heading font-semibold text-[36px] tracking-[-1px] text-[var(--burnt-orange)]">6-7</span>
          <span className="font-label font-bold text-[10px] tracking-[3px] text-[var(--text-muted)]">MONTHS ON TRAIL</span>
        </div>
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-heading font-semibold text-[36px] tracking-[-1px] text-[var(--burnt-orange)]">3</span>
          <span className="font-label font-bold text-[10px] tracking-[3px] text-[var(--text-muted)]">STATES TRAVERSED</span>
        </div>
        <div className="flex flex-col items-center gap-[4px]">
          <span className="font-heading font-semibold text-[36px] tracking-[-1px] text-[var(--forest-green)]">$50K</span>
          <span className="font-label font-bold text-[10px] tracking-[3px] text-[var(--text-muted)]">FUNDRAISING GOAL</span>
        </div>
      </section>

      {/* About The Journey */}
      <section className="flex flex-col gap-[48px] px-[120px] py-[80px] bg-[var(--bg-white)] w-full">
        <div className="flex flex-col items-center gap-[16px] w-full">
          <span className="font-label font-bold text-[12px] tracking-[3px] text-[var(--burnt-orange)]">THE JOURNEY</span>
          <h2 className="font-heading font-semibold text-[40px] tracking-[-0.5px] text-[var(--text-primary)] text-center">
            2,650 Miles From Mexico to Canada
          </h2>
          <p className="font-heading text-[18px] leading-[1.7] text-[var(--text-secondary)] text-center w-[720px]">
      ...
      {/* Trail Progress */}
      <section className="flex flex-col gap-[48px] px-[120px] py-[80px] bg-[var(--bg-warm)] w-full">
        <div className="flex flex-col items-center gap-[16px] w-full">
        ...
        <div className="flex gap-[32px] w-full">
          {/* Map Container */}
          <div className="relative w-[720px] h-[560px] bg-[#E8E5E0] border border-[var(--border-subtle)] overflow-hidden shrink-0">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
      ...
      {/* The Cause */}
      <section className="flex w-full bg-[var(--bg-dark)]">
        <div className="w-[580px] h-[700px] shrink-0 overflow-hidden">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img
        ...
        <div className="flex flex-col justify-center gap-[32px] flex-1 p-[80px]">
          <span className="font-label font-bold text-[12px] tracking-[3px] text-[var(--burnt-orange)]">WHY I WALK</span>
          <h2 className="font-heading font-semibold text-[38px] leading-[1.2] tracking-[-0.5px] text-[var(--text-white)]">
      ...
      {/* Donor Wall */}
      <section className="flex flex-col items-center gap-[48px] px-[120px] py-[80px] bg-[var(--bg-white)] w-full">
        <div className="flex flex-col items-center gap-[16px] w-full">
      ...
      <section className="flex flex-col gap-[48px] px-[120px] py-[80px] bg-[var(--bg-warm)] w-full">
        <div className="flex items-end justify-between w-full">
          <div className="flex flex-col gap-[16px]">
            ...
            <h2 className="font-heading font-semibold text-[40px] tracking-[-0.5px] text-[var(--text-primary)]">
      ...
      <section className="relative w-full h-[480px] overflow-hidden">
        ...
        />
        <div className="relative flex flex-col items-center justify-center gap-[24px] h-full px-[120px]">
          <span className="font-label font-bold text-[12px] tracking-[3px] text-[var(--burnt-orange)]">EVERY MILE MATTERS</span>
          <h2 className="font-heading font-semibold text-[42px] leading-[1.2] tracking-[-0.5px] text-[var(--text-white)] text-center w-[800px]">
          ...
          <div className="flex items-center gap-[16px]">
            <Link
              href="/donate"
              className="flex items-center gap-[10px] bg-[var(--burnt-orange)] px-[48px] py-[20px] hover:opacity-90 transition-opacity"
            >
              <span className="font-label font-bold text-[15px] tracking-[2px] text-[var(--text-white)]">DONATE NOW</span>
              <Heart className="w-[18px] h-[18px] text-[var(--text-white)]" />
            </Link>
            <button className="flex items-center gap-[10px] border border-[#FFFFFF66] px-[48px] py-[20px] hover:bg-white/10 transition-colors">
              <span className="font-label font-bold text-[15px] tracking-[2px] text-[var(--text-white)]">SHARE THIS CAUSE</span>
